...
setwd('/Users/asanchezb/Desktop/gcbonel_scGEX_220921/CTC')
...
# Results path
PLOTS <- '/Users/asanchezb/Desktop/gcbonel_scGEX_220921/CTC/RESULTS/'
...
####################################################################################################
# 4. ADD COPYKAT INFO ANEUPLOIDY
####################################################################################################

# Read copykat prediction
pred.test <- read.table('Desktop/copykat_CTC/test_copykat_prediction.txt', sep = '\t', header = TRUE)
...
# Azimuth predictions
predictions <- read.delim('CTC/azimuth_pred.tsv', row.names = 1)
